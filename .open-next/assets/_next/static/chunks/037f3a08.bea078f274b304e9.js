...
var best_index : i32 = 0;`,`if (${e.getByIndices("input_indices")} ${r.selectLastIndex>0?">=":">"} value) {
    ...
    `,r_=(e,r,i,a,n,s,o,u,l,d,p,c)=>{var h,f,m,g,y,_,b,$,v,w,x,k,S,T,I,E,z,C,A,O,R,B,N,M,D;let U,P,q,W,L,V,G,H,F,j,K,Z,Q,X,Y,J,ee,et,er,ei,ea,en,es,eo,eu,el,ed,ep,ec,eh,ef,em,eg,ey=Math.min(e.outputCount,1+ +!!o+ +!!u),e_=ey>1?o:void 0,eb=ey>1?u:void 0,e$=ey>1?d.pastSequenceLength:0,ev=e$+d.kvSequenceLength,ew=l&&e8.size(l.dims)>0?l:void 0,ex=[r,i];e_&&e8.size(e_.dims)>0&&ex.push(e_),ew&&ex.push(ew),p&&ex.push(p),c&&ex.push(c);let ek=e.compute((h=ey,f=r,m=i,g=e_,y=ew,_=d,b=e$,$=p,v=c,U=b+_.kvSequenceLength,P=[_.batchSize,_.numHeads,_.sequenceLength,U],q=h>1&&g,W=_.kvNumHeads?_.kvNumHeads:_.numHeads,L=q?[_.batchSize,W,U,_.headSize]:void 0,V=_.nReps?_.nReps:1,G=0===_.scale?1/Math.sqrt(_.headSize):_.scale,H=tC(_.headSize),F=_.headSize/H,j={x:Math.ceil(U/12),y:Math.ceil(_.sequenceLength/12),z:_.batchSize*_.numHeads},K=[{type:12,data:_.sequenceLength},{type:12,data:F},{type:12,data:U},{type:12,data:_.numHeads},{type:12,data:_.headSize},{type:1,data:G},{type:12,data:b},{type:12,data:_.kvSequenceLength},{type:12,data:V}],Z=q&&g&&e8.size(g.dims)>0,Q=["type","type"],Z&&Q.push("type"),y&&Q.push("type"),$&&Q.push("type"),v&&Q.push("type"),X=[{dims:P,dataType:f.dataType,gpuDataType:0}],q&&X.push({dims:L,dataType:f.dataType,gpuDataType:0}),{name:"AttentionProbs",shaderCache:{hint:`${H};${void 0!==y};${void 0!==g};${h}`,inputDependencies:Q},getRunData:()=>({outputs:X,dispatchGroup:j,programUniforms:K}),getShaderSource:e=>{let r=tM("q",f.dataType,f.dims,H),i=[r,tM("key",m.dataType,m.dims,H)];if(Z){let e=tM("past_key",g.dataType,g.dims,H);i.push(e)}y&&i.push(tM("attention_bias",y.dataType,y.dims));let a=$?tM("seq_lens",$.dataType,$.dims):void 0;a&&i.push(a);let n=v?tM("total_sequence_length_input",v.dataType,v.dims):void 0;n&&i.push(n);let s=tD("output",f.dataType,P),o=[s];q&&o.push(tD("present_key",f.dataType,L,H));let u=tE(1,H);return`
  const TILE_SIZE = 12u;
...
}`,rP=e=>{let r=tE(e.inputs[0].dataType);e.compute(rw(e.inputs[0],"Erf",e=>`erf_vf32(${e})`,rU(r)))},rq=e=>{e.compute(rw(e.inputs[0],"Exp","exp"))},rW=e=>{e.compute(rw(e.inputs[0],"Floor","floor"))},rL=e=>{let r=tE(e.inputs[0].dataType);e.compute(rw(e.inputs[0],"Gelu",e=>`0.5 * ${e} * (1.0 + erf_vf32(${e} * 0.7071067811865475))`,rU(r)))},rV=(e,r)=>{let i=tE(e.inputs[0].dataType);e.compute(rw(e.inputs[0],"LeakyRelu",e=>`select(leaky_relu_alpha_ * ${e}, ${e}, ${e} >= vec4<${i}>(0.0))`,`const leaky_relu_alpha_ = ${i}(${r.alpha});`,r.cacheKey))},rG=e=>{e.compute(rw(e.inputs[0],"Not",e=>`!${e}`))},rH=e=>{e.compute(rw(e.inputs[0],"Neg",e=>`-${e}`))},rF=e=>{e.compute(rw(e.inputs[0],"Reciprocal",e=>`1.0/${e}`))},rj=e=>{let r=tE(e.inputs[0].dataType);e.compute(rw(e.inputs[0],"Relu",e=>`select(vec4<${r}>(0.0), ${e}, ${e} > vec4<${r}>(0.0))`))},rK=e=>{e.compute(rw(e.inputs[0],"Sigmoid",e=>`(1.0 / (1.0 + exp(-${e})))`))},rZ=e=>tk(e),rQ=(e,r)=>{let i=tE(e.inputs[0].dataType);e.compute(rw(e.inputs[0],"HardSigmoid",e=>`max(vec4<${i}>(0.0), min(vec4<${i}>(1.0), ${r.alpha} * ${e} + vec4<${i}>(${r.beta})))`,void 0,r.cacheKey))},rX=e=>{e.compute(rw(e.inputs[0],"Sin","sin"))},rY=e=>{e.compute(rw(e.inputs[0],"Sinh","sinh"))},rJ=e=>{e.compute(rw(e.inputs[0],"Sqrt","sqrt"))},r0=e=>{e.compute(rw(e.inputs[0],"Tan","tan"))},r1=e=>`sign(${e}) * (1 - exp(-2 * abs(${e}))) / (1 + exp(-2 * abs(${e})))`,r2=e=>{e.compute(rw(e.inputs[0],"Tanh",r1))},r3=(e="f32")=>`
...
`),r.cacheKey,e.inputs[0].dataType))}}),nM=V(()=>{n$(),nI(),nN(),ie=e=>{var r;let i,a,n,s,o,u;(e=>{if(3!==e[0].dims.length)throw Error("input should have 3 dimensions");if(![2560,5120,10240].includes(e[0].dims[2]))throw Error("hidden state should be 2560, 5120 or 10240");if(1!==e[1].dims.length)throw Error("bias is expected to have 1 dimensions");if(e[0].dims[2]!==e[1].dims[0])throw Error("last dimension of input and bias are not the same")})(e.inputs),e.compute(((i=(r=e.inputs)[0].dims.slice())[2]=i[2]/2,a=tM("input",r[0].dataType,r[0].dims,4),n=tM("bias",r[0].dataType,[r[0].dims[2]],4),s=tD("output",r[0].dataType,i,4),o=e8.size(i)/4,u=tI(r[0].dataType),{name:"BiasSplitGelu",getRunData:()=>({outputs:[{dims:i,dataType:r[0].dataType}],dispatchGroup:{x:Math.ceil(o/64)}}),getShaderSource:e=>`
  ...
  ${e.mainStart()}
    ...
    fn pow_vector_custom(a : vec4<${r}>, b : vec4<${r}>) -> vec4<${r}> {
      ...
      `)},iu=e=>{it(e,"Sub",(e,r)=>`${e}-${r}`)},il=e=>{it(e,"Greater",{scalar:(e,r)=>`u32(${e}>${r})`,vector:(e,r)=>`vec4<u32>(${e}>${r})`},void 0,void 0,9)},id=e=>{it(e,"Less",{scalar:(e,r)=>`u32(${e}<${r})`,vector:(e,r)=>`vec4<u32>(${e}<${r})`},void 0,void 0,9)},ip=e=>{it(e,"GreaterOrEqual",{scalar:(e,r)=>`u32(${e}>=${r})`,vector:(e,r)=>`vec4<u32>(${e}>=${r})`},void 0,void 0,9)},ic=e=>{it(e,"LessOrEqual",{scalar:(e,r)=>`u32(${e}<=${r})`,vector:(e,r)=>`vec4<u32>(${e}<=${r})`},void 0,void 0,9)}}),nU=V(()=>{ny(),n$(),nT(),nI(),ih=(e,r)=>{let i=e.inputs,a=i[0].dims,n=e8.normalizeAxis(r.axis,a.length);var s=i,o=n;if(!s||s.length<1)throw Error("too few inputs");let u=s[0],l=u.dataType,d=u.dims.length;s.forEach((e,r)=>{if(0!==r){if(e.dataType!==l)throw Error("input tensors should be one type");if(e.dims.length!==d)throw Error("input tensors should have the same shape");e.dims.forEach((e,r)=>{if(r!==o&&e!==u.dims[r])throw Error("non concat dimensions must match")})}});let p=a.slice();p[n]=i.reduce((e,r)=>e+(r.dims.length>n?r.dims[n]:0),0);let c=i.filter(e=>e8.size(e.dims)>0);e.compute(((e,r,i,a)=>{let n=e8.size(i),s=Array(e.length),o=Array(e.length),u=0,l=[],d=[],p=[{type:12,data:n}];for(let i=0;i<e.length;++i)u+=e[i].dims[r],s[i]=u,d.push(e[i].dims.length),o[i]=tM(`input${i}`,a,d[i]),l.push("rank"),p.push({type:12,data:s[i]});for(let r=0;r<e.length;++r)p.push(...tz(e[r].dims));p.push(...tz(i));let c=tD("output",a,i.length),h=c.indicesGet("indices",r),f=Array.from(Array(s.length).keys()).map(e=>`uniforms.sizeInConcatAxis${e}`).join(",");return{name:"Concat",shaderCache:{hint:`${r}`,inputDependencies:l},getRunData:()=>({outputs:[{dims:i,dataType:a}],dispatchGroup:{x:Math.ceil(n/64)},programUniforms:p}),getShaderSource:r=>{let i,a;return`
...
`)})(o,c)}
  }`}}})(c,n,p,i[0].dataType),{inputs:c})},im=e=>tk({axis:e.axis})}),nP=V(()=>{ny(),n$(),ig=(e,r,i="f32")=>{switch(e.activation){case"Relu":return`value = max(value, ${r}(0.0));`;case"Sigmoid":return`value = (${r}(1.0) / (${r}(1.0) + exp(-value)));`;case"Clip":return`value = clamp(value, ${r}(${i}(uniforms.clip_min)), ${r}(${i}(uniforms.clip_max)));`;case"HardSigmoid":return`value = max(${r}(0.0), min(${r}(1.0), ${i}(uniforms.alpha) * value + ${i}(uniforms.beta)));`;case"LeakyRelu":return`value = select(${i}(uniforms.alpha) * value, value, value >= ${r}(0.0));`;case"Tanh":return`let e2x = exp(-2.0 * abs(value));
              value = sign(value) * (1.0 - e2x) / (1.0 + e2x);
        `;case"":return"";default:throw Error(`Unsupported activation ${e.activation}`)}},iy=(e,r)=>{"Clip"===e.activation?r.push({type:1,data:e.clipMax},{type:1,data:e.clipMin}):"HardSigmoid"===e.activation?r.push({type:1,data:e.alpha},{type:1,data:e.beta}):"LeakyRelu"===e.activation&&r.push({type:1,data:e.alpha})},i_=(e,r)=>{"Clip"===e.activation?r.push({name:"clip_max",type:"f32"},{name:"clip_min",type:"f32"}):"HardSigmoid"===e.activation?r.push({name:"alpha",type:"f32"},{name:"beta",type:"f32"}):"LeakyRelu"===e.activation&&r.push({name:"alpha",type:"f32"})},ib=e=>{let r=e?.activation||"";if("HardSigmoid"===r){let[i,a]=e?.activation_params||[.2,.5];return{activation:r,alpha:i,beta:a}}if("Clip"===r){let[i,a]=e?.activation_params||[e9,te];return{activation:r,clipMax:a,clipMin:i}}if("LeakyRelu"===r){let[i]=e?.activation_params||[.01];return{activation:r,alpha:i}}return{activation:r}}}),nq=V(()=>{i$=(e,r)=>{switch(e){case 1:return r;case 2:return`vec2<${r}>`;case 3:return`vec3<${r}>`;case 4:return`vec4<${r}>`;default:throw Error(`${e}-component is not supported.`)}},iv=e=>`
...
`}),nL=V(()=>{ny(),n$(),nI(),nP(),ix=(e,r,i,a,n)=>{let s=a-i;return`
...
`}return e})()}
  ...
  `}}}}),nV=V(()=>{ny(),n$(),nI(),nP(),nL(),nq(),iS=(e,r,i="f32",a,n=!1,s=32,o=!1,u=32)=>{let l,d,p,c,h=r[1]*e[1],f=r[0]*e[0],m=n?h:s,g=n?s:h,y=m/r[0],_=s/r[1];if(!((n&&4===y&&4===e[1]||!n&&(3===y||4===y))&&m%r[0]==0&&s%r[1]==0&&4===e[0]))throw Error(`If transposeA ${n} is true, innerElementSize ${y} and workPerThread[1] ${e[1]} must be 4.
...
`)};
    ...
    ${e.mainStart()}
    ${e.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.vec_size")}
    ${a}`},getRunData:()=>({outputs:[{dims:s,dataType:r[0].dataType}],dispatchGroup:{x:Math.ceil(p/64)},programUniforms:c})}),{inputs:[0]})}}),n0=V(()=>{ny(),n$(),nI(),nN(),i9=e=>{var r;let i,a,n,s;e.inputs.length<2||0===e8.size(e.inputs[1].dims)?r6(e):e.compute((i=(r=e.inputs)[0].dataType,a=e8.size(r[0].dims),s=(n=e8.size(r[1].dims))%4==0,{name:"FastGeluWithBias",shaderCache:{hint:`${s}`,inputDependencies:["type","type"]},getShaderSource:e=>{let r=tM("x",i,[1],4),a=tM("bias",i,[1],4),n=tD("y",i,[1],4),o=e=>`
...
`)}
  ...
  ${r.mainStart()}
    ...
    ${_?"inv_std_output[global_idx] = inv_std_dev":""};
        ...
        }`}})):e.compute((n=e.inputs,s=r,A=(C=n[0].dims).length,O=C[A-2],R=s.k,B=s.n,N=C.slice(0,A-2),M=e8.size(N),D=n[1].dims[2]/4,U=n[0].dataType,P=tC(s.k),q=tC(D),W=tC(B),L=N.concat([O,B]),V=O>1&&B/W%2==0?2:1,G=e8.size(L)/W/V,H=[],F=[M,O,R/P],(j=e8.convertShape(n[1].dims).slice()).splice(-1,1,D/q),H.push(...tz(F)),H.push(...tz(j)),H.push(...tz(n[2].dims)),4===n.length&&H.push(...tz(e8.convertShape(n[3].dims))),K=[M,O,B/W],H.push(...tz(K)),{name:"MatMulNBits",shaderCache:{hint:`${s.blockSize};${s.bits};${P};${q};${W};${V};64`,inputDependencies:Array(n.length).fill("rank")},getRunData:()=>({outputs:[{dims:L,dataType:U}],dispatchGroup:{x:G},programUniforms:H}),getShaderSource:e=>{let r=F.length,i=tM("a",n[0].dataType,r,P),a=tM("b",12,j.length,q),o=tM("scales",n[2].dataType,n[2].dims.length),u=[i,a,o],l=4===n.length?tM("zero_points",12,n[3].dims.length):void 0;l&&u.push(l);let d=K.length,p=tD("output",n[0].dataType,d,W),c=tI(n[0].dataType),h=(()=>{switch(P){case 1:return`array<${c}, 8>`;case 2:return`mat4x2<${c}>`;case 4:return`mat2x4<${c}>`;default:throw Error(`${P}-component is not supported.`)}})(),f=Math.floor(32/s.bits),m=Math.floor(f/8);return`
