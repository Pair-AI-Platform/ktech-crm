...
export const stageConfig: Record<PipelineStage, { title: string; color: string; bgColor: string }> = {
  ...
  puc_document_submission: { title: "Documents", color: "bg-cyan-500", bgColor: "bg-cyan-50" },
  puc_application_submission: { title: "Submission", color: "bg-emerald-500", bgColor: "bg-emerald-50" },
}
