...
-- =============================================
INSERT INTO schools (name_en, name_ar, governorate, gender) VALUES
  ('Al-Awzai Secondary School', 'ثانوية الأوزاعي', 'capital', 'male'),
  ('Jaber Al-Mubarak Al-Sabah Secondary School', 'ثانوية جابر المبارك الصباح', 'capital', 'male'),
  ('Ahmad Shihab Al-Din Secondary School', 'ثانوية أحمد شهاب الدين', 'capital', 'male'),
  ('Saad Bin Al-Rabee Al-Ansari Secondary School', 'ثانوية سعد بن الربيع الأنصاري', 'capital', 'male'),
  ('Abdullah Al-Otaibi Secondary School', 'ثانوية عبدالله العتيبي', 'capital', 'male'),
  ('Issa Ahmad Al-Hamad Secondary School', 'ثانوية عيسى أحمد الحمد', 'capital', 'male'),
  ('Ahmad Mishari Al-Adwani Secondary School', 'ثانوية أحمد مشاري العدواني', 'capital', 'male'),
  ('Youssef Bin Issa Secondary School', 'ثانوية يوسف بن عيسى', 'capital', 'male'),
  -- CAPITAL - GIRLS
  ('Qurtuba Secondary School for Girls', 'ثانوية قرطبة للبنات', 'capital', 'female'),
  ('Fatima Bint Al-Walid Secondary School', 'ثانوية فاطمة بنت الوليد', 'capital', 'female'),
  -- HAWALLI - BOYS
  ('Jaber Al-Ahmad Al-Sabah Secondary School (Hawalli)', 'ثانوية جابر الأحمد الصباح', 'hawalli', 'male'),
  ('Abdul Razzaq Al-Bassir Secondary School', 'ثانوية عبدالرزاق البصير', 'hawalli', 'male'),
  ('Farhan Al-Khaled Secondary School', 'ثانوية فرحان الخالد', 'hawalli', 'male'),
  ('Palestine Secondary School', 'ثانوية فلسطين', 'hawalli', 'male'),
  ('Salah Al-Din Secondary School', 'ثانوية صلاح الدين', 'hawalli', 'male'),
  ('Fahad Al-Salem Secondary School', 'ثانوية فهد السالم', 'hawalli', 'male'),
  ('Fahd Al-Duwiri Secondary School', 'ثانوية فهد الدويري', 'hawalli', 'male'),
  -- HAWALLI - GIRLS
  ('Maria Al-Qibtiya Secondary School', 'ثانوية ماريا القبطية', 'hawalli', 'female'),
  ('Mushrif Secondary School for Girls', 'ثانوية مشرف للبنات', 'hawalli', 'female'),
  ('Hind Secondary School for Girls', 'ثانوية هند للبنات', 'hawalli', 'female'),
  -- FARWANIYA - BOYS
  ('Al-Shujaa Bin Al-Aslam Secondary School', 'ثانوية الشجاع بن الأسلم', 'farwaniya', 'male'),
  ('Ibn Al-Omaid Secondary School', 'ثانوية ابن العميد', 'farwaniya', 'male'),
  ('Anas Bin Malik Secondary School', 'ثانوية أنس بن مالك', 'farwaniya', 'male'),
  ('Juleib Al-Shuyoukh Secondary School', 'ثانوية جليب الشيوخ', 'farwaniya', 'male'),
  ('Salman Al-Farsi Secondary School', 'ثانوية سلمان الفارسي', 'farwaniya', 'male'),
  ('Abdul Latif Thunayan Al-Ghanem Secondary School', 'ثانوية عبداللطيف ثنيان الغانم', 'farwaniya', 'male'),
  ('Murshid Saad Al-Bathal Secondary School', 'ثانوية مرشد سعد البذال', 'farwaniya', 'male'),
  -- FARWANIYA - GIRLS
  ('Um Ziyad Secondary School for Girls', 'ثانوية أم زياد للبنات', 'farwaniya', 'female'),
  -- AHMADI - BOYS
  ('Al-Zour Secondary School', 'ثانوية الزور', 'ahmadi', 'male'),
  ('Al-Dahr Secondary School', 'ثانوية الظهر', 'ahmadi', 'male'),
  ('Al-Qurtubi Secondary School', 'ثانوية القرطبي', 'ahmadi', 'male'),
  ('Al-Siddiq Secondary School', 'ثانوية الصديق', 'ahmadi', 'male'),
  ('Al-Nasr Secondary School', 'ثانوية النصر', 'ahmadi', 'male'),
  ('Al-Kindi Secondary School', 'ثانوية الكندي', 'ahmadi', 'male'),
  ('Salem Al-Mubarak Secondary School', 'ثانوية سالم المبارك', 'ahmadi', 'male'),
  ('Saeed Bin Amer Secondary School', 'ثانوية سعيد بن عامر', 'ahmadi', 'male'),
  ('Abdullah Al-Ahmad Al-Sabah Secondary School', 'ثانوية عبدالله الأحمد الصباح', 'ahmadi', 'male'),
  ('Omar Bin Al-Khattab Secondary School', 'ثانوية عمر بن الخطاب', 'ahmadi', 'male'),
  ('Hisham Bin Al-Aas Secondary School', 'ثانوية هشام بن العاص', 'ahmadi', 'male'),
  -- AHMADI - GIRLS
  ('Awatif Khalifa Al-Athbi Al-Sabah Secondary School', 'ثانوية عواطف خليفة العذبي الصباح', 'ahmadi', 'female'),
  ('Fatima Bint Asad Secondary School', 'ثانوية فاطمة بنت أسد', 'ahmadi', 'female'),
  ('Lubna Bint Al-Harith Secondary School', 'ثانوية لبنى بنت الحارث', 'ahmadi', 'female'),
  ('Latifa Al-Fares Secondary School', 'ثانوية لطيفة الفارس', 'ahmadi', 'female'),
  ('Muadhah Al-Ghifariya Secondary School', 'ثانوية معاذة الغفارية', 'ahmadi', 'female'),
  ('Hadiya Secondary School for Girls', 'ثانوية هدية للبنات', 'ahmadi', 'female'),
  -- JAHRA - BOYS
  ('Al-Jahra Secondary School for Boys', 'ثانوية الجهراء للبنين', 'jahra', 'male'),
  ('Al-Waha Secondary School', 'ثانوية الواحة', 'jahra', 'male'),
  ('Thabit Bin Qais Secondary School', 'ثانوية ثابت بن قيس', 'jahra', 'male'),
  ('Jaber Al-Abdullah Al-Sabah Secondary School', 'ثانوية جابر العبدالله الصباح', 'jahra', 'male'),
  ('Khaled Bin Saeed Secondary School', 'ثانوية خالد بن سعيد', 'jahra', 'male'),
  ('Orwa Bin Al-Zubayr Secondary School', 'ثانوية عروة بن الزبير', 'jahra', 'male'),
  ('Sabah Al-Nasser Al-Sabah Secondary School', 'ثانوية صباح الناصر الصباح', 'jahra', 'male'),
  -- JAHRA - GIRLS
  ('Amra Bint Rawaha Secondary School', 'ثانوية عمرة بنت رواحة', 'jahra', 'female'),
  ('Fatima Bint Utba Secondary School', 'ثانوية فاطمة بنت عتبة', 'jahra', 'female'),
  ('Al-Jahra Secondary School for Girls', 'ثانوية الجهراء للبنات', 'jahra', 'female'),
  -- MUBARAK AL-KABEER - BOYS
  ('Al-Imam Malik Secondary School', 'ثانوية الإمام مالك', 'mubarak_alkabeer', 'male'),
  ('Jaber Al-Ali Al-Sabah Secondary School', 'ثانوية جابر العلي الصباح', 'mubarak_alkabeer', 'male'),
  ('Suleiman Al-Adassani Secondary School', 'ثانوية سليمان العدساني', 'mubarak_alkabeer', 'male'),
  ('Duaij Al-Salman Al-Sabah Secondary School', 'ثانوية دعيج السلمان الصباح', 'mubarak_alkabeer', 'male'),
  ('Khaled Saud Al-Zaid Secondary School', 'ثانوية خالد سعود الزيد', 'mubarak_alkabeer', 'male'),
  -- MUBARAK AL-KABEER - GIRLS
  ('Faria Bint Abi Al-Salt Secondary School', 'ثانوية فارعة بنت أبي الصلت', 'mubarak_alkabeer', 'female'),
  ('Fatima Al-Hashimiya Secondary School', 'ثانوية فاطمة الهاشمية', 'mubarak_alkabeer', 'female'),
  ('Layla Al-Ghifariya Secondary School', 'ثانوية ليلى الغفارية', 'mubarak_alkabeer', 'female');
